-- Création des tables pour PostgreSQL - ORDRE CORRIGÉ

-- Table: django_content_type (pas de dépendances)
CREATE TABLE django_content_type (
    id INTEGER PRIMARY KEY,
    app_label VARCHAR(100) NOT NULL,
    model VARCHAR(100) NOT NULL);

-- Table: auth_permission (dépend de django_content_type)
...
-- Table: auth_group (pas de dépendances)
CREATE TABLE auth_group (
    id INTEGER PRIMARY KEY,
    name VARCHAR(150) NOT NULL);

-- Table: users_user (pas de dépendances)
...
-- Table: django_migrations (pas de dépendances)
...
-- Table: django_session (pas de dépendances)
CREATE TABLE django_session (
    session_key VARCHAR(40) PRIMARY KEY,
    session_data TEXT NOT NULL,
    expire_date TIMESTAMP NOT NULL);

-- Table: auth_group_permissions (dépend de auth_permission et auth_group)
...
-- Table: users_user_groups (dépend de auth_group et users_user)
...
-- Table: users_user_user_permissions (dépend de auth_permission et users_user)
...
-- Table: django_admin_log (dépend de users_user et django_content_type)
...
-- Table: core_bulletin (dépend de users_user)
...
-- Table: core_conge (dépend de users_user)
...
-- Table: core_permissionrequest (dépend de users_user)
...
-- Table: core_rapport (dépend de users_user)
...
-- Table: core_rapport_destinataires (dépend de core_rapport et users_user)
...
-- Table: core_solde (dépend de users_user)
...
-- Table: payrolls_payroll (dépend de users_user)
...
-- Table: permissions_payroll (dépend de users_user)
...
-- Table: permissions_permissionrequest (dépend de users_user)
